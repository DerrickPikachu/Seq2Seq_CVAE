...
def draw_figure(points: int, data_dic: dict):
    ...
    ax2.plot(x_axis, data_dic['bleu'], 'ro', markersize=2, label='BLEU4-score', color='green')
    ...
    ax2.plot(x_axis, data_dic['gau'], 'ro', markersize=2, label='Gaussian Score', color='brown')
